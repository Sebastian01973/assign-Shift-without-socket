...
public class JCenterPanel extends JPanel {
    ...
    private JModelComboBox<CustomerType> jCBcustomer;
    ...
    private void initComponent(ActionListener actionListener) {
        ...
        jCBcustomer = new JModelComboBox<CustomerType>(Constant.OPTIONS, Constant.ASSIGN_OPTION, Constant.FONT_ARIAL_ROUNDER_17);
    ...
    public Client createClient(){
        if (jCBcustomer.getSelectedIndex() == 0 || jTFNameStore.getText().isEmpty()){
            ...
            if (size <= 9){
                return  new Client(jTFNameStore.getText().substring(0,size),
                        getCustomerType(jCBcustomer.getSelectedIndex()));
            }else {
                return  new Client(jTFNameStore.getText().substring(0,9),
                        getCustomerType(jCBcustomer.getSelectedIndex()));
            }
        }
    }
